...
class KappaMain extends Actor {

  import KappaClusterReceptionist._

  val receptionist = context.actorOf(Props[KappaClusterReceptionist], "receptionist")
  ...
  override def postStop(): Unit = {
    KappaAsyncWebClient.shutdown()
  }

}


class KappaClusterMain extends Actor{
...
class KappaClusterWorker extends Actor with ActorLogging {
  ...
  //override def postStop() = AsyncWebClient.shutdown()
  override def postStop(): Unit = {
    KappaAsyncWebClient.shutdown()
  }
